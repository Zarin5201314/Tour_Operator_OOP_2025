...
public class TouristDashBoardController
{
    ...
    @javafx.fxml.FXML
    public void submitFeedbackOnAction(ActionEvent actionEvent) throws IOException {
    ...
    @Deprecated
    public void onLoadScene1Action(ActionEvent event) throws IOException {
        loadNewScene(event, "Scene1.fxml", "Scene 1");
    }
}